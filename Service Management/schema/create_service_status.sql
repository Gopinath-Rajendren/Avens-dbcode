...
ALTER TABLE service_status ADD CONSTRAINT ss_F FOREIGN KEY (service_id) REFERENCES services (id);

-- Adding the primary key constarint, always follow this method.

ALTER TABLE service_status ADD  CONSTRAINT  ss_P PRIMARY KEY(service_id);
